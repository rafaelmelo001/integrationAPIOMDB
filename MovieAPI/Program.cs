...
builder.Services.AddCors(option =>
{
    ...
    {
        policy.WithOrigins("http://127.0.0.1:5500","http://localhost:5500","integration-apiomdb-jvzi80ch3-rafael-melos-projects-32ef364c.vercel.app").AllowAnyHeader().AllowAnyMethod();
    });
});
